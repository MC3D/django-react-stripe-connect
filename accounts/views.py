...
class StripeAuthorizeAPIView(views.APIView):
    def get(self, request):
        ...
        params = {
            ...
            'redirect_uri': f'http://localhost:8000/api/v1/accounts/oauth/callback/'
        }
...
class StripeAuthorizeCallbackAPIView(views.APIView):
        def get(self, request):
            import pdb; pdb.set_trace()
